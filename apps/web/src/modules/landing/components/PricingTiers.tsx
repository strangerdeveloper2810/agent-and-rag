...
const TIER_ITEMS = [
  { key: "individual", icon: UserIcon, ctaVariant: "outline" as const, highlighted: false },
  { key: "team", icon: UserGroupIcon, ctaVariant: "gradient" as const, highlighted: true },
] as const;
  ...
  return (
    <section className="px-6 py-24 sm:py-28">
      <div className="mx-auto max-w-6xl">
        ...
        >
          {TIER_ITEMS.map(({ key, icon: Icon, ctaVariant, highlighted }, idx) => {
            ...
            return (
              <Card
                ...
                className={cn(
                  ...
                  highlighted && "border-primary/50 shadow-lg shadow-primary/10",
