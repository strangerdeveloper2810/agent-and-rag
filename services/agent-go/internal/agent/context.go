...
func BuildSystemPrompt(memories []string, skillSummaries []skills.SkillSummary, lang string) string {
	...
	b.WriteString("    * `prompt`: Nội dung câu hỏi cụ thể, đi thẳng vào vấn đề kỹ thuật/nghiệp vụ then chốt (ví dụ: 'What is your preferred primary database and caching layer?').\n")
