...
description: Combat preparation — threat assessment, suit diagnostics, tactical analysis, countermeasures
when_to_use: When user mentions combat, threats, suit deployment, hostiles, or defense
tools: [file.read, web.search, shell.exec]
---
...
## Suit Pre-Flight Checklist
1. Power: Arc Reactor charge level, backup batteries
2. Weapons: Repulsors calibrated, missiles loaded, lasers charged
3. Flight: Thrusters tested, stabilizers aligned, fuel sufficient
4. Defense: Armor integrity, energy shields, countermeasures
5. Comms: Secure channel with Pepper, Rhodey, Happy
6. Medical: Emergency protocols, life support systems

## Tactical Analysis
- Identify threat type: human, metahuman, alien, technological, unknown
- Known weaknesses for identified threats
- Environmental factors: terrain, civilians, collateral damage radius
